...
<head>
  ...
  <link rel="stylesheet" href="<?=base_url() ?>assets/admin/jquery-ui.css">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  ...
                  <div class="pull-right">
                    <a href="<?php echo base_url() ?>admin/A_account/logout" class="btn btn-default btn-flat">Sign out</a>
                  </div>
                </li>
              </ul>
            </li>
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="<?php echo ($nav == 'reservation' ? 'active' : '') ?>">
            <a href="<?=base_url() ?>admin/A_Reservation">
              <i class="fa fa-link"></i>
              <span>Reservation</span>
            </a>
          </li>
          <li class="<?php echo ($nav == 'customer' ? 'active' : '') ?>">
            <a href="<?=base_url() ?>admin/A_customer">
              <i class="fa fa-link"></i>
              <span>Customer</span>
            </a>
          </li>
          <li class="<?php echo ($nav == 'rute' ? 'active' : '') ?>">
            <a href="<?=base_url() ?>admin/A_Rute">
              <i class="fa fa-link"></i>
              <span>Rute</span>
            </a>
          </li>
          <li class="<?php echo ($nav == 'transportation' ? 'active' : '') ?>">
            <a href="<?=base_url() ?>admin/A_Transportation">
              <i class="fa fa-link"></i>
              <span>Transportation</span>
            </a>
          </li>
          <li class="<?php echo ($nav == 'user' ? 'active' : '') ?>">
            <a href="<?=base_url() ?>admin/A_user">
              <i class="fa fa-link"></i>
              <span>User</span>
            </a>
          </li>
